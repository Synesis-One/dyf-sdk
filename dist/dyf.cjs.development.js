    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          instructions = [];
          signers = [];
          _PublicKey$findProgra = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF')], PROGRAM_ID), pdaAccount = _PublicKey$findProgra[0];
          _PublicKey$findProgra2 = web3.PublicKey.findProgramAddressSync([pdaAccount.toBuffer(), Buffer.from('DYF:VAULT')], PROGRAM_ID), dyfVault = _PublicKey$findProgra2[0];
          _tokenBalance = null;
          _context.next = 11;
        ...
        case 15:
          userToken = getAssociateTokenAccount(new web3.PublicKey(SNS_ADDRESS), publicKey);
          _context.next = 18;
          return connection.getAccountInfo(userToken);
        case 18:
          accountInfo = _context.sent;
          if (accountInfo == null) {
            instructions.push(splToken.createAssociatedTokenAccountInstruction(publicKey, userToken, publicKey, new web3.PublicKey(SNS_ADDRESS), splToken.TOKEN_PROGRAM_ID, splToken.ASSOCIATED_TOKEN_PROGRAM_ID));
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          _PublicKey$findProgra = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(campaignTitle)], PROGRAM_ID), campaignAccount = _PublicKey$findProgra[0];
          _PublicKey$findProgra2 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:VAULT'), Buffer.from(campaignTitle)], PROGRAM_ID), campaignVault = _PublicKey$findProgra2[0];
          _PublicKey$findProgra3 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID), farmConfigAccount = _PublicKey$findProgra3[0];
          _context2.next = 30;
          return FarmConfig.fromAccountAddress(connection, farmConfigAccount, 'processed');
        case 30:
          farmConfig = _context2.sent;
          userToken = getAssociateTokenAccount(new web3.PublicKey(SNS_ADDRESS), publicKey);
          _PublicKey$findProgra4 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF')], PROGRAM_ID), pdaAccount = _PublicKey$findProgra4[0];
          ...
          instructions.push(createCreateCampaignInstruction({
            ...
            campaignVault: campaignVault,
            userToken: userToken,
            mint: new web3.PublicKey(SNS_ADDRESS),
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          close = new BN(data.close);
          expire = new BN(data.expire);
          _PublicKey$findProgra6 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(data.campaignTitle)], PROGRAM_ID), campaignAccount = _PublicKey$findProgra6[0];
          _PublicKey$findProgra7 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID), farmConfig = _PublicKey$findProgra7[0];
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 12:
          ...
          break;
        case 17:
          _PublicKey$findProgra8 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(str)], PROGRAM_ID), campaignAccount = _PublicKey$findProgra8[0];
          _context4.next = 20;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          _PublicKey$findProgra3 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(campaignTitle)], PROGRAM_ID), campaignAccount = _PublicKey$findProgra3[0];
          userToken = getAssociateTokenAccount(new web3.PublicKey(SNS_ADDRESS), publicKey);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          instructions = [];
          signers = [];
          _PublicKey$findProgra6 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra6[0];
          _PublicKey$findProgra7 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(campaignTitle)], PROGRAM_ID), campaignAccount = _PublicKey$findProgra7[0];
          _PublicKey$findProgra8 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:VAULT'), Buffer.from(campaignTitle)], PROGRAM_ID), campaignVault = _PublicKey$findProgra8[0];
          _PublicKey$findProgra9 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF')], PROGRAM_ID), pdaAccount = _PublicKey$findProgra9[0];
          _PublicKey$findProgra10 = web3.PublicKey.findProgramAddressSync([pdaAccount.toBuffer(), Buffer.from('DYF:VAULT')], PROGRAM_ID), dyfVault = _PublicKey$findProgra10[0];
          _PublicKey$findProgra11 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:ACTIVITY'), Buffer.from(campaignTitle), publicKey.toBuffer()], PROGRAM_ID), campaignActivity = _PublicKey$findProgra11[0];
          _PublicKey$findProgra12 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID), farmConfig = _PublicKey$findProgra12[0];
          userToken = getAssociateTokenAccount(new web3.PublicKey(SNS_ADDRESS), publicKey);
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          instructions = [];
          signers = [];
          _PublicKey$findProgra13 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra13[0];
          userToken = getAssociateTokenAccount(new web3.PublicKey(SNS_ADDRESS), publicKey);
          _PublicKey$findProgra14 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:ACTIVITY'), Buffer.from(campaignTitle), publicKey.toBuffer()], PROGRAM_ID), campaignActivity = _PublicKey$findProgra14[0];
          _PublicKey$findProgra15 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:VAULT'), Buffer.from(campaignTitle)], PROGRAM_ID), campaignVault = _PublicKey$findProgra15[0];
          _PublicKey$findProgra16 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID), farmConfig = _PublicKey$findProgra16[0];
          _PublicKey$findProgra17 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF')], PROGRAM_ID), pdaAccount = _PublicKey$findProgra17[0];
          _PublicKey$findProgra18 = web3.PublicKey.findProgramAddressSync([pdaAccount.toBuffer(), Buffer.from('DYF:VAULT')], PROGRAM_ID), dyfVault = _PublicKey$findProgra18[0];
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          throw new Error('Connection is undefined');
        case 4:
          _PublicKey$findProgra19 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra19[0];
          userToken = getAssociateTokenAccount(new web3.PublicKey(SNS_ADDRESS), publicKey);
          _PublicKey$findProgra20 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID), farmConfig = _PublicKey$findProgra20[0];
          _PublicKey$findProgra21 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF')], PROGRAM_ID), pdaAccount = _PublicKey$findProgra21[0];
          _PublicKey$findProgra22 = web3.PublicKey.findProgramAddressSync([pdaAccount.toBuffer(), Buffer.from('DYF:VAULT')], PROGRAM_ID), dyfVault = _PublicKey$findProgra22[0];
          instructions = campaignTitles.map(function (campaignTitle) {
            var _PublicKey$findProgra23 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:ACTIVITY'), Buffer.from(campaignTitle), publicKey.toBuffer()], PROGRAM_ID),
              campaignActivity = _PublicKey$findProgra23[0];
            var _PublicKey$findProgra24 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:VAULT'), Buffer.from(campaignTitle)], PROGRAM_ID),
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          instructions = [];
          signers = [];
          _PublicKey$findProgra25 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra25[0];
          _PublicKey$findProgra26 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID), farmConfigAccount = _PublicKey$findProgra26[0];
          userNft = getAssociateTokenAccount(new web3.PublicKey(mint), publicKey);
          _PublicKey$findProgra27 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:VAULT'), userNft.toBuffer()], PROGRAM_ID), nftVault = _PublicKey$findProgra27[0];
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 2:
          ...
          throw new Error('Connection is undefined');
        case 4:
          _PublicKey$findProgra30 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra30[0];
          _context7.next = 7;
            ...
            var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(campaign) {
              ...
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    _context6.prev = 2;
                    _PublicKey$findProgra31 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:ACTIVITY'), Buffer.from(campaign.campaignTitle), publicKey.toBuffer()], PROGRAM_ID), campaignActivityAccount = _PublicKey$findProgra31[0];
                    _context6.next = 6;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error('Connection is undefined');
        case 4:
          _PublicKey$findProgra = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(campaign.campaignTitle)], PROGRAM_ID), campaignAccount = _PublicKey$findProgra[0];
          _context2.next = 7;
          return getSubmissionsValidationsInfo(campaign.pubkey);
        case 7:
          ...
          return Promise.all(submissionsNotSubmittedButRpcFinalizedOrExpired.map( /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(submission) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _PublicKey$findProgra2 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:PHRASE'), campaignAccount.toBuffer(), Buffer.from(submission.canonical)], PROGRAM_ID), phraseAccount = _PublicKey$findProgra2[0];
                    _context.prev = 1;
                    _context.next = 4;
...
var createBuilderSubmitUtterancesInstructions = function createBuilderSubmitUtterancesInstructions(publicKey, connection, campaignTitle, utterances) {
  ...
  var instructions = [];
  var signers = [];
  var _PublicKey$findProgra3 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(campaignTitle)], PROGRAM_ID),
    campaignAccount = _PublicKey$findProgra3[0];
  var _PublicKey$findProgra4 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID),
    farmConfig = _PublicKey$findProgra4[0];
  var _PublicKey$findProgra5 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID),
    userProfile = _PublicKey$findProgra5[0];
  var _PublicKey$findProgra6 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:ACTIVITY'), Buffer.from(campaignTitle), publicKey.toBuffer()], PROGRAM_ID),
    campaignActivity = _PublicKey$findProgra6[0];
  instructions = utterances.map(function (utterance) {
    var _PublicKey$findProgra7 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:PHRASE'), campaignAccount.toBuffer(), Buffer.from(utterance.canonical)], PROGRAM_ID),
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          return _context.abrupt("return");
        case 9:
          _PublicKey$findProgra = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(campaignMeta.dapp_title)], PROGRAM_ID), campaignAccount = _PublicKey$findProgra[0]; // @ts-ignore
          campaign = undefined;
          _context.prev = 11;
          _context.next = 14;
        ...
        case 19:
          ...
          return _context.abrupt("return");
        case 21:
          _PublicKey$findProgra2 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:ACTIVITY'), Buffer.from(campaignMeta.dapp_title), publicKey.toBuffer()], PROGRAM_ID), campaignActivityAccount = _PublicKey$findProgra2[0];
          stakeInfo = {
        ...
        case 26:
          ...
          _PublicKey$findProgra3 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra3[0];
          _context.next = 30;
          return Profile.fromAccountAddress(connection, userProfile, 'processed');
        case 30:
          profile = _context.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          role = null;
          _context2.prev = 8;
          _PublicKey$findProgra4 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra4[0];
          _context2.next = 12;
          return Profile.fromAccountAddress(connection, userProfile, 'processed');
        case 12:
  ...
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(publicKey, connection) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          _context2.prev = 4;
          _PublicKey$findProgra2 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra2[0];
          _context2.next = 8;
          return Profile.fromAccountAddress(connection, userProfile, 'processed');
        case 8:
          profile = _context2.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          signers = [];
          _PublicKey$findProgra3 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID), userProfile = _PublicKey$findProgra3[0];
          _PublicKey$findProgra4 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID), farmConfigAccount = _PublicKey$findProgra4[0];
          _context3.next = 10;
          return FarmConfig.fromAccountAddress(connection, farmConfigAccount, 'processed');
        case 10:
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return _context.abrupt("return");
                  case 2:
                    _PublicKey$findProgra = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:PHRASE:LOG'), Buffer.from(campaign.campaignTitle), new web3.PublicKey(submission.pubkey).toBuffer(), publicKey.toBuffer()], PROGRAM_ID), historyAccount = _PublicKey$findProgra[0];
...
var createValidatorValidateUtterancesInstructions = function createValidatorValidateUtterancesInstructions(publicKey, connection, campaignTitle, validations) {
  ...
  var instructions = [];
  var signers = [];
  var _PublicKey$findProgra2 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN'), Buffer.from(campaignTitle)], PROGRAM_ID),
    campaignAccount = _PublicKey$findProgra2[0];
  var _PublicKey$findProgra3 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CONFIG')], PROGRAM_ID),
    farmConfig = _PublicKey$findProgra3[0];
  var _PublicKey$findProgra4 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:PROFILE'), publicKey.toBuffer()], PROGRAM_ID),
    userProfile = _PublicKey$findProgra4[0];
  var _PublicKey$findProgra5 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:ACTIVITY'), Buffer.from(campaignTitle), publicKey.toBuffer()], PROGRAM_ID),
  ...
  instructions = validations.map(function (validation) {
    ...
    var _PublicKey$findProgra6 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:PHRASE:LOG'), Buffer.from(campaignTitle), phraseAccount.toBuffer(), publicKey.toBuffer()], PROGRAM_ID),
      logAccount = _PublicKey$findProgra6[0];
    var _PublicKey$findProgra7 = web3.PublicKey.findProgramAddressSync([Buffer.from('DYF:CAMPAIGN:ACTIVITY'), Buffer.from(campaignTitle), new web3.PublicKey(validation.builder).toBuffer()], PROGRAM_ID),
  ...
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(publicKey, connection) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          _tokenBalance = 0;
          ata = getAssociateTokenAccount(new web3.PublicKey(SNS_ADDRESS), publicKey);
          _context2.next = 8;
...
exports.KANON_NFT_AUTHORITY_ADDRESS = KANON_NFT_AUTHORITY_ADDRESS;
exports.KANON_NFT_CHARITY_ADDRESS = KANON_NFT_CHARITY_ADDRESS;
...
exports.SNS_ADDRESS = SNS_ADDRESS;
...
exports.getSubmissionsInfo = getSubmissionsInfo;
...
exports.getValidationsInfo = getValidationsInfo;
