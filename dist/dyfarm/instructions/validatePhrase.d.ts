 ...
 * @category generated
 */
export declare type ValidatePhraseInstructionArgs = {
 ...
 * @category generated
 */
export declare const validatePhraseStruct: beet.FixableBeetArgsStruct<ValidatePhraseInstructionArgs & {
 ...
 * @category generated
 */
export declare type ValidatePhraseInstructionAccounts = {
    user: web3.PublicKey;
...
export declare const validatePhraseInstructionDiscriminator: number[];
/**
 ...
 * @category generated
 */
export declare function createValidatePhraseInstruction(accounts: ValidatePhraseInstructionAccounts, args: ValidatePhraseInstructionArgs, programId?: web3.PublicKey): web3.TransactionInstruction;
